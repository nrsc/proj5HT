...
brain.metadata =  data.frame(
  ...
  pra.introns = sMD$percent_reads_aligned_to_introns_label,
  score.Corr = sMD$score.Corr_label,
  class_Corr = sMD$class_Corr
)
  

sMD$percent_reads_aligned_to_introns_label
